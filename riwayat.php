		...
		<div class="container-fluid">
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<div class="subtitle">Antrian <?= $_SESSION['nama_layanan']; ?></div>
						</div>
					</div>
				</div>
			</header>
			<div class="form-group-row">
					<form name="form1" action="" method="get">
						...
						<label for="exampleSelect" class="col-sm-2 form-control-label">Pilih Status</label>
						<div class="col-sm-2">
							<select onchange="this.form.submit()"  id="exampleSelect" name="j" class="form-control" required>
			...
			<section class="card">
				<div class="card-block">
					<table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<?php
						$i=0;
						if ($_GET['mulai'] == NULL && $_GET['selesai'] == NULL && $_GET['j'] == NULL){
						$s_antrian = mysqli_query($koneksi,"SELECT * from antrian where status!='0' AND kategori ='$_SESSION[kode]'  order by id desc");
						} else {
						$s_antrian = mysqli_query($koneksi,"SELECT * from antrian where status!='0' AND kategori ='$_SESSION[kode]' AND date(date_antri) between '$_GET[mulai]' AND '$_GET[selesai]' AND status='$_GET[j]' order by id desc");
						}
